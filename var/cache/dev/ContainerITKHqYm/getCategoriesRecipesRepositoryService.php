...
// Returns the private 'App\Repository\CategoriesRecipesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CategoriesRecipesRepository.php';

return $this->privates['App\Repository\CategoriesRecipesRepository'] = new \App\Repository\CategoriesRecipesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
