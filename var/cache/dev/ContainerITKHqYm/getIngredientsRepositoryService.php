...
// Returns the private 'App\Repository\IngredientsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\IngredientsRepository.php';

return $this->privates['App\Repository\IngredientsRepository'] = new \App\Repository\IngredientsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
