...
$this->privates['maker.auto_command.make_entity'] = $instance = new \Symfony\Bundle\MakerBundle\Command\MakerCommand(new \Symfony\Bundle\MakerBundle\Maker\MakeEntity($a, $this->targetDirs[3], ($this->services['doctrine'] ?? $this->getDoctrineService())), $a);
