...
// Returns the private 'App\Repository\StatusRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StatusRepository.php';

return $this->privates['App\Repository\StatusRepository'] = new \App\Repository\StatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
