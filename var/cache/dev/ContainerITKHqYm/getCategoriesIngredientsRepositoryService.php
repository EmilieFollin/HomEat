...
// Returns the private 'App\Repository\CategoriesIngredientsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CategoriesIngredientsRepository.php';

return $this->privates['App\Repository\CategoriesIngredientsRepository'] = new \App\Repository\CategoriesIngredientsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
