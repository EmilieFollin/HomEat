...
// Returns the private 'App\Repository\RecipesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RecipesRepository.php';

return $this->privates['App\Repository\RecipesRepository'] = new \App\Repository\RecipesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
