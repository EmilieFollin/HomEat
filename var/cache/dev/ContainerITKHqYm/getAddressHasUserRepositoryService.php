...
// Returns the private 'App\Repository\AddressHasUserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AddressHasUserRepository.php';

return $this->privates['App\Repository\AddressHasUserRepository'] = new \App\Repository\AddressHasUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
