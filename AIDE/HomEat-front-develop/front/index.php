...
<div class="filtre-accueil">
    <div class="container z-depth-3" id="filtre-container">
    <form action="#">
        <div class="row">
            <div class="input-field col s12">
    ...
    <div class="liste-plat">
        <div class="row">
          ...
          <div class="col s12 m6 l6 xl4" id="div-card" style="margin: 30px 0px 30px 0px">
                ...
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light activator" style=" background: url(https://imagesvc.timeincapp.com/v3/mm/image?url=http%3A%2F%2Fcdn-image.foodandwine.com%2Fsites%2Fdefault%2Ffiles%2Fstyles%2F4_3_horizontal_inbody_900x506%2Fpublic%2F1502824044%2Froyal-farms-best-gas-station-food-FT-SS0817.jpg%3Fitok%3Dig79fdSU&w=700&q=85); background-position: center;
    background-size: cover">
            ...
            <div class="col s12 m6 l6 xl4" id="div-card" style="margin: 40px 0px 40px 0px">
                <a class="btn-floating btn-large waves-effect waves-light" id="panier"><i class="material-icons">shopping_cart</i></a>
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light activator" style=" background: url(http://sguru.org/wp-content/uploads/2018/03/food.jpg)">
                        <img class="activator" id="img-plat" src="">
                        <div class="cuisto">
                            <a href="#!user">
                                <img id="profil-cuisto-card" class="circle" src="https://scontent-cdt1-1.xx.fbcdn.net/v/t1.0-1/c0.0.160.160/p160x160/20767735_1634982593192961_209014930482741611_n.jpg?oh=05cdc29ff8b2698d5d8c0927a15c5a51&oe=5B36D7D2">
                            </a>
    ...
    background-size: cover">
            ...
            <div class="col s12 m6 l6 xl4" id="div-card" style="margin: 40px 0px 40px 0px">
                <a class="btn-floating btn-large waves-effect waves-light" id="panier"><i class="material-icons">shopping_cart</i></a>
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light activator" style=" background: url(http://sguru.org/wp-content/uploads/2018/03/food.jpg); background-size: cover; background-position: center">
                        <img class="activator" id="img-plat" src="">
                        <div class="cuisto">
                            <a href="#!user">
                                <img id="profil-cuisto-card" class="circle" src="https://scontent-cdt1-1.xx.fbcdn.net/v/t1.0-1/c0.0.160.160/p160x160/20767735_1634982593192961_209014930482741611_n.jpg?oh=05cdc29ff8b2698d5d8c0927a15c5a51&oe=5B36D7D2">
